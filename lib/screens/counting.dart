                ...
                if (snapshot.hasData) {
                  return MediaQuery.removePadding(
                    ...
                    child: GridView.builder(
                      ...
                      itemCount: (snapshot.data as List<NumberEntity>).length,
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                          ...
                          child: TileCard(
                            ...
                            title: (snapshot.data as List<NumberEntity>)[index].text,
                            textColor: getIndexColor(index),
                            onTap: () {
                              setState(() {
                                _selectedIndex = index;
                              });
                              _playAudio((snapshot.data as List<NumberEntity>)[index].audio);
                            },
                          ),
                        );
                      },
